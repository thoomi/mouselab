...
-- -----------------------------------------------------
-- Table `kopietzmasterlive`.`tl_resilience_question`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `kopietzmasterlive`.`tl_resilience_question` ;

CREATE TABLE IF NOT EXISTS `kopietzmasterlive`.`tl_resilience_question` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `q_num_1` SMALLINT(6) NOT NULL,
  `q_num_2` SMALLINT(6) NOT NULL,
  `q_num_3` SMALLINT(6) NOT NULL,
...
-- -----------------------------------------------------
-- Table `kopietzmasterlive`.`tl_maximizing_question`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `kopietzmasterlive`.`tl_maximizing_question` ;

CREATE TABLE IF NOT EXISTS `kopietzmasterlive`.`tl_maximizing_question` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `q_num_1` SMALLINT(6) NOT NULL,
  `q_num_2` SMALLINT(6) NOT NULL,
  `q_num_3` SMALLINT(6) NOT NULL,
...
-- -----------------------------------------------------
-- Table `kopietzmasterlive`.`tl_trial`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `kopietzmasterlive`.`tl_trial` ;

CREATE TABLE IF NOT EXISTS `kopietzmasterlive`.`tl_trial` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `kopietzmasterlive`.`tl_meta_question`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `kopietzmasterlive`.`tl_meta_question` ;

CREATE TABLE IF NOT EXISTS `kopietzmasterlive`.`tl_meta_question` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `q_num_1` SMALLINT(6) NOT NULL,
  `q_num_2` SMALLINT(6) NOT NULL,
  `q_num_3` SMALLINT(6) NOT NULL,
...
-- -----------------------------------------------------
-- Table `kopietzmasterlive`.`tl_nfc_question`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `kopietzmasterlive`.`tl_nfc_question` ;

CREATE TABLE IF NOT EXISTS `kopietzmasterlive`.`tl_nfc_question` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `q_num_1` SMALLINT(6) NOT NULL,
  `q_num_2` SMALLINT(6) NOT NULL,
  `q_num_3` SMALLINT(6) NOT NULL,
...
-- -----------------------------------------------------
-- Table `kopietzmasterlive`.`tl_risk_question`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `kopietzmasterlive`.`tl_risk_question` ;

CREATE TABLE IF NOT EXISTS `kopietzmasterlive`.`tl_risk_question` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `q_num_1` SMALLINT(6) NOT NULL,
  `q_num_2` SMALLINT(6) NOT NULL,
  `q_num_3` SMALLINT(6) NOT NULL,
